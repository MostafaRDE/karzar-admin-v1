...
export default [
    ...
    { title: 'کاراکتر ها', icon: 'users2', route: { name: 'charactersList', params: { status: 'pending' } }, roles: [ROLES.SUPER_ADMIN] },
    ...
    { title: 'ارتباط با ما', icon: 'phone-wave', route: { name: 'contactUsList' }, roles: [ROLES.SUPER_ADMIN, ROLES.EXECUTOR] },
]
