...
export default [
    ...
    { title: 'درگاه های ورودی', icon: 'wallet', route: { name: 'depositGatewaysList' }, roles: [ROLES.SUPER_ADMIN] },
    { title: 'درگاه های خروجی', icon: 'wallet', route: { name: 'withdrawGatewaysList' }, roles: [ROLES.SUPER_ADMIN] },
