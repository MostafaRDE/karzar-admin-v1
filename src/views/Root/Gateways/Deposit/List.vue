        ...
        methods: {
            ...
            storeGateway () {
                ...
                switch (this.modals.gateway.type) {
                    case 'ADD':
                        storeGateway(this.modals.gateway.fields.name, JSON.stringify(this.modals.gateway.fields.key1), JSON.stringify(this.modals.gateway.fields.key2), this.modals.gateway.fields.image, 0)
                            .then(response => {
                                this.$toast.success({
                                    title: 'افزودن درگاه',
                    ...
                    case 'EDIT':
                        updateGateway(this.modals.gateway.id, this.modals.gateway.fields.name, JSON.stringify(this.modals.gateway.fields.key1), JSON.stringify(this.modals.gateway.fields.key2), this.modals.gateway.fields.image, 0)
                            .then(response => {
                                this.$toast.success({
                                    title: 'ویرایش درگاه',
