                    ...
                    <div class="sidebar-user-material">
                        <div class="sidebar-user-material-body">
                            <div class="card-body text-center">
                                <a href="#">
                                    <img src="../assets/global_assets/images/image.png"
                            ...
                            <div class="sidebar-user-material-footer">
                                <a href="#user-nav"
                                   ...
                                   data-toggle="collapse"><span>Navigation</span></a>
                            </div>
                        </div>
                            ...
                            <li class="nav-item nav-item-submenu nav-item-expanded nav-item-open">
                                ...
                                <ul class="nav nav-group-sub" data-submenu-title="Starter kit">
                                    ...
                                    <li class="nav-item"><a href="../seed/navbar_fixed_both.html" class="nav-link">Both
                                        navbars fixed</a></li>
                                    <li class="nav-item"><a href="../seed/layout_fixed.html" class="nav-link active">Fixed
                                        layout</a></li>
                                </ul>
                            </li>
                            <li class="nav-item">
                ...
                <div class="page-header page-header-light">
                    <div class="page-header-content header-elements-md-inline">
                        <div class="page-title d-flex">
                            <h4><i class="icon-arrow-right6 mr-2"></i> <span
                                class="font-weight-semibold">Starters</span> - Fixed Layout</h4>
                ...
                <div class="content">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p class="mb-3">Common problem of templates is that all code is deeply integrated into the
                                core. This limits your freedom in decreasing amount of code, i.e. it becomes pretty
                            ...
                            <p class="mb-3">Starter kit is a set of pages, useful for developers to start development
                                process from scratch. Each layout includes base components only: layout, page kits,
                                color system which is still optional, bootstrap files and bootstrap overrides. No extra
                                CSS/JS files and markup. CSS files are compiled without any plugins or components.
                            ...
                            <p>You open one of the starter pages, add necessary plugins, uncomment paths to files in
                                ...
                                pages with functionality you need and copy all paths/JS code from there to your new
                                page, it's just faster and easier.</p>
                        </div>
                    </div>
                    <!-- /basic card -->
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            Seed project includes the most basic components that can help you in development process -
                            basic grid example, card, table and form layouts with standard components. Nothing extra.
                            Easily turn on and off styles of different components in <code>_config.scss</code> file so
                            that your CSS is always as clean as possible. Bootstrap components are always enabled
                            though.
                        </div>
